...
class TestSlideGenerator:
    ...
    @pytest.fixture
    def generator(self) -> SlideGenerator:
        """Fixture to provide a SlideGenerator instance"""
        return SlideGenerator()

    def test_fill_template_success(self, generator):
    ...
    def test_fill_template_missing_key(self, generator):
    ...
    def test_ensure_placeholder_defaults_known(self, generator):
        """Test that known placeholders get default values"""
        data = {"topic_1": "My Topic"}
        result = generator._ensure_placeholder_defaults(data)
        assert result["topic_1"] == "My Topic"
        assert result["presentation_title"] == "Title"

    def test_ensure_placeholder_defaults_unknown(self, generator):
    ...
    def test_ensure_placeholder_defaults_non_string(self, generator):

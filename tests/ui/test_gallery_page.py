...
class TestGalleryPageLogic:
    ...
    def test_template_repository_integration(self):
        ...
        with patch.object(TemplateRepository, 'get_all_templates') as mock_get_templates:
    ...
    def test_grid_layout_logic(self):
        ...
        rows_needed = (len(templates) + cols_per_row - 1) // cols_per_row  # Ceiling division
    ...
    def test_page_title_and_content_logic(self):
        ...
        page_description = "スライドテンプレートを選択して、ダウンロードページに進んでください。"
        
        assert page_title == "🎼 テンプレートギャラリー"
        assert page_description == "スライドテンプレートを選択して、ダウンロードページに進んでください。"
